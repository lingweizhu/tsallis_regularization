...
% \begin{figure}
%     \centering
%     \includegraphics[width=0.33\textwidth]{img/Gaussian_ks.png}
%     \caption{xs}
% \end{figure}
% \begin{figure}
%     \centering
